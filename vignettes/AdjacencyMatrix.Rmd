...
```{r}
plotAdjacencyMatrix(connectedComponents(cc, 920))
```
...
We will use the second one, with index 1082 to learn about the
`plotAdjacencyMatrix()` function and explore how to inform our
peptides filtering beyond the `filterPsm*()` functions.
