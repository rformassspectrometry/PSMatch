...
```{r, eval = FALSE}
## Use only singly-charged fragments
plotSpectraPTM(sp1158[2], allCharges = FALSE)

## Use custom charge states for multiple spectra
plotSpectraPTM(sp1158[1:2], z = c(2, 3), allCharges = TRUE)
```
