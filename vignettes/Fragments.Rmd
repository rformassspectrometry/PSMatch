...
b- and y-ion fragment sequences. Labels are automatically applied based on the 
...
is applied (interestingly, as glycine has the same mass as cabamidomethylation, 
...
For a more complete comprehension of what `plotSpectraPTM()` can do, run
`?plotSpectraPTM`.
